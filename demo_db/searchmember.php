    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <p>  </p>
                  <form action="searchmember.php" class="form-group my-3" method="POST">
                    <label for="search">ค้นหา:</label><br>
                    <div class="row">
                      <div class="col-6">
                        <input type="text" placeholder="กรอกชื่อหรือนามสกุล" class="form-control" name="search" required>
                      </div>
                      <div class="col-6">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <!--ลบข้อมูล-->
                            <td><a href="deletemember.php?emp_id=<?php echo $row["emp_id"] ?>" class="btn btn-danger" onclick="return confirm('ยืนยันการลบข้อมูล')">ลบ</a></td>
