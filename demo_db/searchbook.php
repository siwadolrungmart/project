    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <p>  </p>
                <form action="searchbook.php" class="form-group my-3" method="POST">
                    <label for="search">ค้นหา:</label><br>
                    <div class="row">
                      <div class="col-6">
                        <input type="text" placeholder="กรอกชื่อหนังสือ/ชื่อผู้แต่ง/ประเภท" class="form-control" name="search" required>
                      </div>
                      <div class="col-6">
                    ...
                    <table class="table table-bordered">
                      <thead class="table-dark">
                        <tr>
                          ...
                          <th>ประเภท</th>
                          <th>จำนวนหนังสือ</th>
                          <th>จำนวนหนังสือประจำห้องสมุด</th>
                          <th>แก้ไข</th>
                          <th>ลบ</th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $row["quantity_library"]; ?></td>
                            <!--แก้ไขข้อมูล-->
                            <td><a href="editformbook.php?emp_id=<?php echo $row["emp_id"] ?>" class="btn btn-success">แก้ไข</a></td>
              
                            <!--ลบข้อมูล-->
                            <td><a href="deletebook.php?emp_id=<?php echo $row["emp_id"] ?>" class="btn btn-danger" onclick="return confirm('ยืนยันการลบข้อมูล')">ลบ</a></td>
